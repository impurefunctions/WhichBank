...
public class CustomDialog  extends Dialog implements View.OnClickListener {
    ...
    public interface OnSweetClickListener {
        void onClick(CustomDialog customAlertDialog);
    }
...
//
//        mDialogView = getWindow().getDecorView().findViewById(android.R.gig_id.client);
//        mTitleTextView = (TextView)findViewById(cn.pedant.SweetAlert.R.gig_id.title_text);
//        mContentTextView = (TextView)findViewById(cn.pedant.SweetAlert.R.gig_id.content_text);
//        mErrorFrame = (FrameLayout)findViewById(cn.pedant.SweetAlert.R.gig_id.error_frame);
//        mErrorX = (ImageView)mErrorFrame.findViewById(cn.pedant.SweetAlert.R.gig_id.error_x);
//        mSuccessFrame = (FrameLayout)findViewById(cn.pedant.SweetAlert.R.gig_id.success_frame);
//        mProgressFrame = (FrameLayout)findViewById(cn.pedant.SweetAlert.R.gig_id.progress_dialog);
//        mSuccessTick = (SuccessTickView)mSuccessFrame.findViewById(cn.pedant.SweetAlert.R.gig_id.success_tick);
//        mSuccessLeftMask = mSuccessFrame.findViewById(cn.pedant.SweetAlert.R.gig_id.mask_left);
//        mSuccessRightMask = mSuccessFrame.findViewById(cn.pedant.SweetAlert.R.gig_id.mask_right);
//        mCustomImage = (ImageView)findViewById(cn.pedant.SweetAlert.R.gig_id.custom_image);
//        mWarningFrame = (FrameLayout)findViewById(cn.pedant.SweetAlert.R.gig_id.warning_frame);
//        mConfirmButton = (Button)findViewById(cn.pedant.SweetAlert.R.gig_id.confirm_button);
//        mCancelButton = (Button)findViewById(cn.pedant.SweetAlert.R.gig_id.cancel_button);
//        mProgressHelper.setProgressWheel((ProgressWheel)findViewById(cn.pedant.SweetAlert.R.gig_id.progressWheel));
//        mConfirmButton.setOnClickListener(this);
//        mCancelButton.setOnClickListener(this);

        setContentView(R.layout.alert_dialog_reset_dialog);
    ...
    private void restore () {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.blue_button_bg);
